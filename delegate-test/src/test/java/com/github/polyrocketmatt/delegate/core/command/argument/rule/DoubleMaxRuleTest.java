...
public class DoubleMaxRuleTest {

    private final double max = 5.0;
    @SuppressWarnings("FieldCanBeLocal") private final String validInclusiveInput = "5.0";
    @SuppressWarnings("FieldCanBeLocal") private final String validExclusiveInput = "4.0";
    @SuppressWarnings("FieldCanBeLocal") private final String invalidInput = "10.0";

    @Test
    public void testPrimaryConstructor() {
        DoubleMaxRule rule = new DoubleMaxRule(max, false);
        ...
        assertEquals(5.0, rule.getMax());
        assertFalse(rule.isInclusive());
    }

    @Test
    public void testSecondaryConstructor() {
        DoubleMaxRule rule = new DoubleMaxRule(max);
    ...
    public void testInterpretValidResultInclusive() {
        ...
        assertEquals("Successfully passed DoubleMaxRule", ruleResult.info());
    }
