...
public class FloatRangeArgumentTest {
    ...
    public void testPrimaryConstructor() {
        FloatRangeArgument argument = FloatRangeArgument.of("identifier", "description");
        ...
        assertEquals(DelegateFloatRange.class, argument.getArgumentType());
    }

    @Test
    public void testSecondaryConstructor() {
        DelegateFloatRange range = new DelegateFloatRange(0.0f, 1.0f);
        FloatRangeArgument argument = FloatRangeArgument.of("identifier", "description", range);
    ...
    public void testTernaryConstructor() {
        FloatRangeArgument argument = FloatRangeArgument.of("identifier", "description", new NonNullRule());
    ...
    public void testQuaternaryConstructor() {
        DelegateFloatRange range = new DelegateFloatRange(0.0f, 1.0f);
        FloatRangeArgument argument = FloatRangeArgument.of("identifier", "description", range,
                new FloatMinRule(0f), new FloatMaxRule(1f));
    ...
    public void testInternalParserSuccess() {
        DelegateFloatRange range = new DelegateFloatRange(0.0f, 1.0f);
        FloatRangeArgument argument = FloatRangeArgument.of("identifier", "description", range);
        Argument<DelegateFloatRange> parsedArgumentA = argument.parse("0.0f-1.0f");
        Argument<DelegateFloatRange> parsedArgumentB = argument.parse("0.1f-3.14f");

        assertEquals(new DelegateFloatRange(0.0f, 1.0f), parsedArgumentA.output());
        assertEquals(new DelegateFloatRange(0.1f, 3.14f), parsedArgumentB.output());
    }

    @Test
    public void testInternalParserInputNull() {
        DelegateFloatRange range = new DelegateFloatRange(0.0f, 1.0f);
        FloatRangeArgument argumentA = FloatRangeArgument.of("identifier", "description");
        FloatRangeArgument argumentB = FloatRangeArgument.of("identifier", "description", range);
    ...
    public void testInternalParserFailureWithDefault() {
        DelegateFloatRange range = new DelegateFloatRange(0.0f, 1.0f);
        FloatRangeArgument argument = FloatRangeArgument.of("identifier", "description", range);
        Argument<DelegateFloatRange> parsedArgumentA = argument.parse("0.");
        Argument<DelegateFloatRange> parsedArgumentB = argument.parse("not a number");
        Argument<DelegateFloatRange> parsedArgumentC = argument.parse("0_0");
        Argument<DelegateFloatRange> parsedArgumentD = argument.parse("0L_0");
        Argument<DelegateFloatRange> parsedArgumentE = argument.parse("0--0");
        Argument<DelegateFloatRange> parsedArgumentF = argument.parse("0-0-1");
    ...
    public void testBrigadierParserSuccess() {
        DelegateFloatRange range = new DelegateFloatRange(0.0f, 1.0f);
        FloatRangeArgument argument = FloatRangeArgument.of("identifier", "description", range);
        StringReader reader = new StringReader("0.0f-2.0f");

        assertEquals(new DelegateFloatRange(0.0f, 2.0f), argument.parse(reader));
    }
