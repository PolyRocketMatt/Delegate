...
public class CommandAction extends CommandAttribute implements Bufferable {
    ...
    public CommandAction(String identifier, int precedence, Function<List<Argument<?>>, ?> action) {
        super(identifier);
        this.precedence = precedence;
        this.action = action;
    }

    public CommandAction(String identifier, Function<List<Argument<?>>, ?> action) {
        super(identifier);
        this.precedence = 0;
        this.action = action;
    }
