...
public class FloatRangeRule extends ArgumentRule<Boolean> {
     ...
     */
    public FloatRangeRule(float min, float max, boolean leftInclusive, boolean rightInclusive) {
        super(input -> {
            try {
     ...
     * @param max The maximum value.
     */
    public FloatRangeRule(float min, float max) {
